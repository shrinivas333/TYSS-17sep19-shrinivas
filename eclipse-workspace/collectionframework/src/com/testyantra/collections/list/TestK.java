...
public class TestK {
	...
	public static void main(String[] args) {
		...
		al.remove(0);
		System.out.println("After removing the 0th index: "+al);
		al.remove(null);
		System.out.println("After removing a null :"+al);
		Double val=al.get(4);
		System.out.println("Object at 4 th index: "+val);
		al.set(2, 77.56);
		System.out.println("After replacing the value at 2nd index: "+al);
		al.clear();
		...
		System.out.println("Removed all of al1"+al);
